...
import { smLoader } from '../Layouts/Loader'
      ...
      <div className=' h-[50vh] w-full '>
        ...
        <div className='mt-3 sm:mx-auto sm:w-full sm:max-w-sm '>
          <form className=' space-y-6' onSubmit={handleSubmit(submit)}>
            ...
            <div>
              <button type='submit' disabled={loadingRQ} className=' w-full h-full flex items-center justify-center bg-orange-600/80 hover:bg-orange-600/90 active:bg-orange-600/70 text-white py-1.5 text-sm font-semibold leading-6 shadow-sm ' >
                {loadingRQ ? <Spinner /> : "log in"}
              </button>
            </div>
          </form>
